...
export default function TodayScreen(): React.JSX.Element {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.emptyWrap}>
          ...
          <Text style={styles.emptyTitle}>정보가 없어요</Text>
          <Text style={styles.emptySub}>계산기 탭에서 먼저 생리 시작일을 입력해주세요</Text>
        </View>
      </View>
    );
  }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {/* 주기 요약 카드 */}
      <View style={[styles.summaryCard, {borderColor: info.color, backgroundColor: info.bg}]}>
        <View style={styles.summaryRow}>
          <View style={styles.summaryItem}>
            <Text style={styles.summaryValue}>{dayInCycle}</Text>
            <Text style={styles.summaryLabel}>주기 {dayInCycle}일째</Text>
          </View>
          <View style={styles.summaryDivider} />
          <View style={styles.summaryItem}>
            <Text style={styles.summaryValue}>{cycleLength}</Text>
            <Text style={styles.summaryLabel}>주기 길이</Text>
          </View>
          <View style={styles.summaryDivider} />
          <View style={styles.summaryItem}>
            <Text style={[styles.summaryValue, {color: PINK}]}>{daysUntil}</Text>
            <Text style={styles.summaryLabel}>생리까지 D-{daysUntil}</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  summaryValue: {fontSize: 26, fontWeight: '800', color: '#222'},
